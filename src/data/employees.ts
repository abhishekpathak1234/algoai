...
import { Users, PhoneCall, MessageSquare, Database, Wallet, HeartHandshake, CalendarCheck, Megaphone, LineChart, Building2, Briefcase, Shield, Cog, type LucideIcon } from "lucide-react";
...
const extra: Employee[] = [
  {
    slug: "ai-receptionist", name: "AI Receptionist", category: "Support", icon: Building2,
    tagline: "First voice every prospect hears — always on, always on-brand.",
    seoTitle: "AI Receptionist — Algo Realty",
    seoDescription: "24/7 AI Receptionist for real estate — routes calls, books meetings and captures every inquiry.",
    heroTitle: "The receptionist that never misses a call.",
    heroSub: "Always-on front desk that routes calls, books meetings, captures inquiries and represents your brand at every hour.",
    kpis: [
    ...
    benefits: ["24/7 pickup", "Zero missed inquiries", "On-brand voice", "Instant routing", "Complete audit log", "Multi-lingual"],
    integrations: ["Exotel", "Twilio", "Ozonetel", "Google Calendar", "Outlook", "Salesforce"],
    faqs: [
      { q: "Can it hand off to a human?", a: "Yes — warm-transfers with context when the caller asks or when the AI detects intent it should not handle." },
      { q: "Does it integrate with our PBX?", a: "Yes — SIP trunk or cloud telephony (Exotel, Twilio, Ozonetel, Knowlarity)." },
      { q: "Is call recording compliant?", a: "Consent capture, recording, redaction and retention policies are all configurable to your jurisdiction." },
    ],
    related: ["ai-telecaller", "voice-ai", "ai-support"],
    department: "Front Office",
  },
  {
    slug: "ai-channel-partner-manager", name: "AI Channel Partner Manager", category: "Sales", icon: Cog,
    tagline: "Activate, train and grow every channel partner at scale.",
    seoTitle: "AI Channel Partner Manager — Algo Realty",
    seoDescription: "AI Employee that onboards, trains and drives revenue from every channel partner in your network.",
    heroTitle: "Grow channel revenue without adding partner managers.",
    heroSub: "Onboards partners, tracks deal registrations, computes commissions, runs training and drives partner activation — automatically.",
    kpis: [
    ...
    responsibilities: [
      { title: "Partner onboarding", body: "KYC, agreements, credentials and training — all automated." },
      { title: "Deal registration", body: "Instant validation, conflict resolution and confirmation." },
    ...
    benefits: ["Automated onboarding", "Instant deal reg", "Accurate commissions", "24/7 partner support", "Training on demand", "Full leaderboard"],
    integrations: ["Salesforce PRM", "HubSpot", "Zoho", "WhatsApp Business", "Slack"],
    faqs: [
      { q: "Can it prevent commission disputes?", a: "Yes — every deal registration is time-stamped and conflicts are surfaced instantly with an auditable trail." },
      { q: "Does it work for franchise networks?", a: "Yes — hierarchical partner structures, sub-brokers and franchisees are supported." },
      { q: "Can partners self-serve?", a: "Partners get a WhatsApp/portal interface to register deals, check commissions and access training." },
    ],
    related: ["ai-crm", "ai-marketing", "revenue-intelligence"],
    department: "Partnerships",
  },
  {
    slug: "ai-inventory-manager", name: "AI Inventory Manager", category: "Operations", icon: Building2,
    tagline: "Real-time unit availability, hold expiry and pricing sync.",
    seoTitle: "AI Inventory Manager — Algo Realty",
    seoDescription: "Real-time inventory sync across projects, channels and CRMs — no double-bookings.",
    heroTitle: "Inventory that's always accurate. Everywhere.",
    heroSub: "Live unit availability, hold expiry, dynamic pricing and channel sync across every project.",
    kpis: [
    ...
    responsibilities: [
      ...
      { title: "Hold management", body: "Enforces hold expiry and releases inventory automatically." },
    ...
    benefits: ["Real-time accuracy", "Zero double-bookings", "Automated holds", "Dynamic pricing", "Portal + partner sync", "Audit trail"],
    integrations: ["Salesforce", "LeadSquared", "Sell.Do", "99acres", "Housing.com", "MagicBricks"],
    faqs: [
      { q: "How fast is the sync?", a: "Under 2 seconds end-to-end across every downstream channel." },
      { q: "Can pricing be time-based?", a: "Yes — time-of-day, launch, festive and demand-based pricing rules are supported." },
      { q: "Does it prevent holds abuse?", a: "Yes — hold windows expire automatically and re-releases the unit." },
    ],
    related: ["ai-crm", "revenue-intelligence", "ai-sales-executive"],
    department: "Operations",
  },
  {
    slug: "ai-compliance-officer", name: "AI Compliance Officer", category: "Support", icon: Shield,
    tagline: "RERA, KYC and audit-trail compliance — automated.",
    seoTitle: "AI Compliance Officer — Algo Realty",
    seoDescription: "AI Employee for RERA, KYC and audit-trail compliance across every real estate transaction.",
    heroTitle: "Compliance without the compliance team.",
    heroSub: "RERA disclosures, KYC verification, consent logs and audit trails — enforced on every conversation and transaction.",
    kpis: [
    ...
    responsibilities: [
      { title: "RERA disclosures", body: "Ensures every asset shared carries mandated disclosures." },
      { title: "KYC / eSign", body: "Automates identity verification and eSign flows." },
      { title: "Consent capture", body: "Explicit consent logged for calls, WhatsApp and marketing." },
    ...
    benefits: ["Automated RERA disclosures", "eKYC + eSign", "Consent capture", "Immutable audit trails", "Region-specific policies", "Regulator-ready exports"],
    integrations: ["Salesforce", "DocuSign", "Aadhaar eKYC", "WhatsApp Business"],
    faqs: [
      { q: "Which jurisdictions are supported?", a: "RERA (India), FTC (US), GDPR (EU) and configurable rules for any region." },
      { q: "Can we run our own policies?", a: "Yes — the rules engine is configurable per project and region." },
