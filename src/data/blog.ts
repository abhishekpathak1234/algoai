...
export const blogCategories: BlogCategory[] = [
  ...
  { slug: "marketing", name: "Marketing", description: "Attribution, spend and lead-quality tactics." },
  ...
  { slug: "property-management", name: "Property Management", description: "For property management leaders." },
  { slug: "automation", name: "Automation", description: "Workflow automation across real estate." },
...
export type BlogPost = { slug: string; title: string; excerpt: string; category: string; readTime: string; published: string };
...
const seed: [string, string, string, string?][] = [
  // AI
  ["How AI Increases Property Sales", "The mechanics behind AI-driven revenue lift in real estate.", "ai"],
  ["AI Workforce vs Chatbots", "Why AI Employees own outcomes and chatbots don't.", "ai"],
  ["Future of AI Employees in Real Estate", "The org chart of a $10B AI-native real estate company.", "ai"],
  ["AI Workforce vs Traditional Teams", "Head-to-head economics of an AI-first sales org.", "ai"],
  ["What Enterprise AI Actually Means", "Beyond the buzzword — enterprise AI defined operationally.", "ai"],
  ["Building an AI-Ready Real Estate Company", "The five capabilities every CEO must build.", "ai"],
  ["The AI Workforce Operating Model", "How to structure human + AI teams for maximum leverage.", "ai"],
  ["AI, Governance and Real Estate", "Governing an AI Workforce with the same rigor as human employees.", "ai"],
  // Sales
  ["Reducing Lead Leakage in Real Estate", "A framework to plug every leak between marketing and closing.", "sales"],
  ["Why Speed Wins in Real Estate Sales", "Response time is the biggest lever on conversion.", "sales"],
  ["Sales Productivity Metrics That Matter", "The 6 metrics executives should track weekly.", "sales"],
  ["The New Sales Stack for Builders", "How the modern builder sales stack is being re-designed.", "sales"],
  ...
  ["Google Ads for Developers", "Search + PMax structures for multi-project portfolios.", "marketing"],
  ["Portal Lead Economics", "99acres, Housing, MagicBricks: yield and quality benchmarks.", "marketing"],
  ...
  ["Site Visits That Convert 2x Better", "Show-up rates and post-visit follow-through.", "builders"],
  ...
  // Developers
  ["Voice AI for Developers", "Deploying voice AI across enterprise developer portfolios.", "developers"],
  ...
  ["Channel Partner Programs That Convert", "Partner activation, deal reg and commissions.", "developers"],
  ...
  ["Commission Automation Without Disputes", "Automated, auditable commission processing.", "brokerages"],
  ["Referral Management for Brokerages", "Referrals as a first-class revenue channel.", "brokerages"],
  ["Coaching a National Broker Team", "Using AI to coach thousands of brokers.", "brokerages"],
  ["Franchise-friendly AI Deployment", "Rolling AI across franchisees without brand drift.", "brokerages"],
  // Property Management
  ["Automating Rent Reminders", "How AI keeps DSO under 7 days.", "property-management"],
  ["Maintenance Ticket Automation", "Instant triage, routing and SLA tracking.", "property-management"],
  ["Tenant Communication at Scale", "White-glove tenant experience without more staff.", "property-management"],
  ["Occupancy Reporting for Leadership", "Real-time occupancy across a national portfolio.", "property-management"],
  ...
  ["Automation Debt in Real Estate", "How teams accumulate automation debt — and pay it back.", "automation"],
  ["Change Management for Automation", "Rolling out automation without team pushback.", "automation"],
  // Analytics
  ["Pipeline Forecasting for Real Estate", "Forecasting bookings by project, month and rep.", "analytics"],
  ["Revenue Intelligence Explained", "What it is and why every real estate CEO needs it.", "analytics"],
  ["Anomaly Detection on Sales Funnels", "Catching drops before they become quarterly misses.", "analytics"],
  ["Executive Dashboards That Get Used", "Design principles for dashboards leaders open every day.", "analytics"],
  ["Attribution Models Compared", "Last-click, linear, time-decay, data-driven.", "analytics"],
  ["Cohort Analysis for Real Estate", "Booking cohorts, retention and lifetime value.", "analytics"],
  // Voice AI
  ...
  // Extras to reach 100
  ["Improving Collections in Real Estate", "The end-to-end collections operating model.", "automation"],
  ["Sales Productivity for Enterprise Builders", "Systems that raise the median rep by 2x.", "sales"],
  ["Marketing Attribution for Multi-project Portfolios", "Attribute across 20+ projects with one truth.", "marketing"],
  ["Revenue Forecasting for MDs", "What good forecasting looks like in real estate.", "analytics"],
  ["Buyer Qualification Playbook", "The 12 questions every AI Sales Executive should ask.", "sales"],
  ["Reducing No-shows on Site Visits", "Multi-channel confirmations that lift show-up 30%+.", "builders"],
  ["Post-booking Customer Experience", "Everything after signing the agreement.", "property-management"],
  ["The CEO's Guide to AI Workforce ROI", "Modelling ROI before deployment.", "ai"],
  ["Building a Command Center for Real Estate", "The Bloomberg-terminal experience for real estate leadership.", "analytics"],
  ...
  ["Multi-region AI Deployments", "Playbook for multi-country real estate portfolios.", "developers"],
];
