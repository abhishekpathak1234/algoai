...
export const caseStudies: CaseStudy[] = [
  {
    ...
    challenge: "Marketing generated 42,000 leads/month but sales response time averaged 4h 12m. Site-visit show-up sat at 38% and CRM compliance was 51%. Millions of dollars in pipeline was leaking every quarter.",
    solution: "Deployed AI Sales Executive, AI Telecaller, AI WhatsApp Executive, AI CRM Executive, AI Site Visit Coordinator and AI Collections. Integrated LeadSquared, Exotel, WhatsApp Business and Google Ads. Went live in 4 weeks.",
    impact: [
  ...
  },
  {
    ...
    challenge: "Rapid portfolio growth meant each new project stretched an already-thin sales team. Marketing spend rose 3x but conversion collapsed.",
    solution: "Rolled out AI Workforce across all 42 projects with project-specific playbooks. Marketing Analyst reallocated $4.8M of spend to higher-ROI channels within 90 days.",
    impact: [
    ...
    quote: "Every new launch used to take 3 months of hiring and ramp. Now we deploy the AI Workforce in a week.",
  ...
  },
  {
    ...
    challenge: "Broker productivity varied 10x. Best brokers hoarded leads; the tail rarely closed. Commission disputes clogged operations.",
    solution: "AI CRM Executive rebalanced lead distribution by score, load and closing history. AI Channel Partner Manager automated commission calc.",
    impact: [
  ...
  },
  {
    ...
    challenge: "Manual rent reminders and maintenance ticket routing pushed collections cycles beyond 40 days. Tenant NPS was slipping.",
    ...
    quote: "Rent reminders, receipts, tickets — everything runs itself. Our team focuses on retention and growth now.",
  ...
  },
  {
    ...
    challenge: "Multi-year leasing cycles with 8+ stakeholders per deal. Follow-ups slipped. Documentation packages took weeks.",
    solution: "Deployed AI Sales Executive tuned for institutional buyers plus AI Compliance Officer for documentation. Revenue Intelligence surfaced at-risk deals weekly.",
    impact: [
  ...
  },
  {
    ...
    challenge: "HNW clients expect same-day, multilingual concierge across time zones. Small team could not scale without diluting brand.",
    solution: "AI Concierge (customised AI Sales + AI Support) in 24 languages with private-showing scheduling and NDA-aware conversations.",
    impact: [
