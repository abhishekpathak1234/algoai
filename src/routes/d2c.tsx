...
const title = "D2C & Commerce — AlgoBridge Enterprise AI Workflow Intelligence";
const description =
  "AlgoBridge runs governed revenue operations across D2C and commerce workflows — cart recovery, order intervention, RTO prevention, retention and support escalation.";

export const Route = createFileRoute("/d2c")({
  head: () => ({
    meta: [
      { title },
      ...
      { property: "og:url", content: "/d2c" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: "/d2c" }],
  }),
  component: D2CPage,
});
  ...
  return (
    <PageShell>
      <PageHeader
        ...
        trail={[{ label: "Home", href: "/" }, { label: "D2C & Commerce" }]}
      />
