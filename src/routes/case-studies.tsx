...
export const Route = createFileRoute("/case-studies")({
  head: () => ({
    ...buildMeta({
      ...
      description: "Illustrative enterprise deployments of Algo Realty's AI Workforce across builders, developers, brokerages, property management and commercial real estate.",
      path: "/case-studies",
    }),
  }),
...
function CaseStudiesHub() {
  return (
    <HubPage
      ...
      title={<>How leaders deploy <span className="text-emerald-grad">AI Workforces.</span></>}
