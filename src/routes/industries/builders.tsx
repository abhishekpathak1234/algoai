  ...
  head: () => ({
    meta: [
      { title: "AI Workforce for Builders — Algo Realty" },
      {
        name: "description",
        content:
          "Automate lead qualification, site visits, CRM, collections and customer communication so your builder sales team can focus on closing bookings.",
      },
      { property: "og:title", content: "AI Workforce for Builders — Algo Realty" },
      {
        property: "og:description",
        content:
          "Deploy AI Employees across every builder workflow — from Facebook lead to final collections.",
      },
    ],
  }),
...
const data: IndustryPageProps = {
  ...
  heroTitle: (
    <>
      AI Workforce for <span className="text-emerald-grad">Builders.</span>
    </>
  ),
  heroSub:
    "Automate lead qualification, site visits, customer communication, collections and CRM — so your sales team focuses on closing more bookings, not chasing leads.",
  heroKpis: [
  ...
  painPoints: [
    {
      ...
      body: "Leads expect answers in minutes. Delayed contact silently kills conversion for every new launch.",
    },
    {
      icon: PhoneMissed,
      title: "Missed Calls",
      body: "High-intent inquiries drop off when sales lines are busy, after hours or during launches.",
    },
    {
      icon: Users,
      title: "Lead Leakage",
      body: "Marketing spends millions generating demand — sales loses most of it in the handoff.",
    },
    {
      icon: Database,
      title: "Unupdated CRM",
      body: "Sales teams spend hours logging calls instead of selling — pipeline visibility disappears.",
    },
    {
      icon: CalendarCheck,
      title: "Unconfirmed Site Visits",
      body: "Manual reminders and reschedules drop attendance and waste sales capacity on-site.",
    },
    {
      icon: Wallet,
      title: "Delayed Collections",
      body: "Manual EMI and milestone reminders slow cashflow and increase operational overhead.",
    },
  ],
  impacts: [
  ...
  employees: [
    {
      ...
      icon: Users,
      skills: [
        "Qualifies buyers 24/7",
        "Answers pricing and inventory",
        "Books meetings on calendars",
        "Recommends floor plans",
      ],
    },
    {
      name: "AI Telecaller",
    ...
    },
    {
      ...
      icon: MessageSquare,
      skills: ["Instant replies", "Brochures + floor plans", "Payment links", "Media sharing"],
    },
    {
    ...
    },
    {
      ...
      icon: CalendarCheck,
      skills: [
        "Schedules and confirms visits",
        "Coordinates on-site staff",
        "Auto-reschedules",
  ...
  faqs: [
    {
      q: "Can AI handle high lead volume during launches?",
      a: "Yes. The AI Workforce scales elastically to handle thousands of concurrent inquiries within seconds, without adding headcount.",
    },
    {
      q: "Will it integrate with our existing builder CRM?",
      a: "Algo Realty integrates natively with Salesforce, LeadSquared, Sell.Do, Zoho and most builder-grade CRMs — bi-directional sync out of the box.",
    },
    {
      q: "Can AI qualify buyers accurately?",
      a: "AI Sales Executives qualify on budget, timeline, configuration and intent using your exact playbook and disqualifies noise before sales sees the lead.",
    },
    {
      q: "Does it support multiple languages?",
      a: "Yes — Hindi, English, regional Indian languages and international languages are supported across voice and chat.",
    },
    {
      q: "Can it manage collections and milestone reminders?",
      a: "The AI Collections Executive automates milestone-based reminders, tracks outstandings and escalates to finance only when needed.",
    },
    {
      q: "How long does deployment take?",
      a: "A typical builder deployment goes live in 3–5 weeks, including CRM integrations, telephony and workflow calibration.",
    },
  ],
};
