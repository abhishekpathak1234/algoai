...
export const Route = createFileRoute("/ai-employees")({
  head: () => ({
    ...buildMeta({
      ...
      description: "Hire AI Employees across sales, marketing, CRM, finance, operations, support and leadership. Deploy your AI Workforce in weeks.",
      path: "/ai-employees",
    }),
  }),
...
function EmployeesHub() {
  return (
    <HubPage
      ...
      title={<>Hire your <span className="text-emerald-grad">AI Workforce.</span></>}
      intro="Every AI Employee is specialised, deployable in weeks and orchestrated with your existing team, CRM and channels."
      crumbs={[{ name: "Home", path: "/" }, { name: "AI Employees", path: "/ai-employees" }]}
