...
export const Route = createFileRoute("/about")({
  head: () => ({
    ...buildMeta({
      ...
      description:
        "Algo Realty is the AI Workforce for real estate — a product by AlgoBridge, deployed across leading builders, developers and brokerages worldwide.",
      path: "/about",
    }),
    scripts: [
      breadcrumbLd([
        ...
        <section className="relative overflow-hidden pt-8 pb-16">
          ...
          <div className="mx-auto max-w-[1080px] px-6">
            ...
            <p className="mt-6 max-w-2xl text-[16px] leading-relaxed text-muted-foreground">
              Algo Realty is a product by AlgoBridge. We build AI Employees that run alongside real
              estate teams — increasing revenue, reducing lead leakage and scaling operations
          ...
          <div className="mx-auto grid max-w-[1080px] gap-8 px-6 md:grid-cols-2">
            <div className="rounded-2xl border border-border bg-card p-8">
              ...
              <h2 className="mt-4 font-display text-3xl">
                Give every real estate company an AI Workforce.
              </h2>
              <p className="mt-4 text-[14px] leading-relaxed text-muted-foreground">
                Real estate is a $326 trillion asset class. It's operated on WhatsApp threads,
                spreadsheets and short-staffed telecalling floors. We're changing that.
              </p>
            </div>
            <div className="rounded-2xl border border-border bg-card p-8">
              <div className="text-[11px] uppercase tracking-widest text-muted-foreground">
              ...
              <p className="mt-4 text-[14px] leading-relaxed text-muted-foreground">
                Every AI Employee at Algo Realty owns an outcome. Not a workflow. Not a feature. An
                outcome — the same way a great human employee does.
              </p>
            </div>
          </div>
        </section>
