...
export const Route = createFileRoute("/solutions")({
  head: () => ({
    ...buildMeta({
      ...
      description: "Explore Algo Realty's AI Solutions — AI Sales Executive, AI Telecaller, AI WhatsApp, AI CRM, AI Collections, Voice AI, Revenue Intelligence and more.",
      path: "/solutions",
    }),
  }),
...
function SolutionsHub() {
  return (
    <HubPage
      eyebrow="Solutions"
      title={<>An AI Employee for every part of the <span className="text-emerald-grad">revenue engine.</span></>}
